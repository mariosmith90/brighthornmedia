#!/usr/bin/env node
/**
 * Prepares build artifacts for Firebase deploy:
 ...
 *   3. Copies functions-only deps (no Next.js) to keep function bundle small
 */
...
// 2. Prerendered HTML files → public/ (Firebase Hosting serves them as static pages)
...
console.log("\nBuild artifacts ready for Firebase deploy.");
